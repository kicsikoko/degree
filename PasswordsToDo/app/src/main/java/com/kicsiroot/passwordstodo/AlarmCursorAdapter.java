...
public class AlarmCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        return LayoutInflater.from(context).inflate(R.layout.reminder_item, viewGroup, false);
    }
    ...
    // Set repeat views
    public void setReminderRepeatInfo(@NotNull String repeat, String repeatNo, String repeatType) {
    ...
    public void setActiveImage(@NotNull String active){
        if(active.equals("true")){
            mActiveImage.setImageResource(R.drawable.ic_noti_on);
        }else if (active.equals("false")) {
            mActiveImage.setImageResource(R.drawable.ic_noti_off);
        }
    }
