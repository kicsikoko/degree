...
import com.kicsiroot.passwordstodo.AlarmReminderContract;
import com.kicsiroot.passwordstodo.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Views
        mToolbar = (Toolbar) findViewById(R.id.addReminderToolbar);
        ...
        MenuItem item = findViewById(R.id.discard_reminder);
        ...
        mRepeatText.setText(R.string.every + mRepeatNo + R.string.empty + mRepeatType + R.string.s);
